...
| Open   | Remaining fixture module prose still needs live quality review.     | Add module-specific prompts and gates for `trope-mutation-lab` and `council-review` before those outputs become production-facing.                                                                |
